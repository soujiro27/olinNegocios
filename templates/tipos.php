...
<div class="container row expanded">
	...
	<main class="columns medium-10">
		<div class="row expanded headerMain align-middle">
			<div class="columns medium-4">
				<p>Lista de Tipos de Suscripcion</p>
			</div>
			<div class="columns medium-2">
				<button class="button" id="addCategoria">Agregar Tipo</button>
			</div>
		</div>
		<table class="stack">
			<thead>
				<th>Nombre</th>
				<th>Promociones por Mes</th>
			</thead>
			<tbody></tbody>
		</table>
		<div class="form row expanded">
			<form class="categorias">
				<div class="input">
					...
					<label>Numero de Promociones por Mes</label>
					<input type="number" name="promociones" id="promociones" requires placeholder="Promociones por mes">
				</div>
				<div class="botones">
